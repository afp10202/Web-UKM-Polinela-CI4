                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        'is-invalid ' : ''; ?>" id="nama_ukm" name="nama_ukm" value="<?= old('nama_ukm'); ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control <?= isset($errors['logo']) ?
                                        'is-invalid' : ''; ?>" id="logo_ukm" name="logo_ukm" value="<?= old('logo_ukm'); ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        'is-invalid' : ''; ?>" id="foto_dua" name="foto_dua" value="<?= old('foto_dua'); ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control <?= isset($errors['link_ig']) ?
                                        'is-invalid' : ''; ?>" id="link_ig" name="link_ig" value="<?= old('link_ig'); ?>">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control <?= isset($errors['link_yt']) ?
                                        'is-invalid' : ''; ?>" id="link_yt" name="link_yt" value="<?= old('link_yt'); ?>">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        'is-invalid' : ''; ?>" id="visi" name="visi" cols="50" rows="6">
                                        <?= old('visi'); ?></textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        'is-invalid' : ''; ?>" id="misi" name="misi" cols="50" rows="6"><?= old('misi'); ?>
                                        </textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        'is-invalid' : ''; ?>" id="informasi" name="informasi" cols="50" rows="6">
                                        <?= old('informasi'); ?></textarea>
