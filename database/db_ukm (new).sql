...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Jul 2023 pada 14.23
...
(2, 2, 'Ukmbspolinela@gmail.com', 'https://instagram.com/ukm_bspolinela?igshid=MmU2YjMzNjRlOQ==', 'https://youtube.com/@ukmbspolinela9405'),
(4, 6, 'poltapalalpg@gmail.com', 'https://instagram.com/poltapala_lampung?igshid=NTc4MTIwNjQ2YQ==', 'https://youtube.com/@poltapalalampung4942');
...
(6, 'UKM Poltapala', '1689398318_6b1a8f9036b89d0ac72e.png', 'Poltapala merupakan singkatan dari \"Politeknik Pecinta Alam Lampung\" yang didirikan pada tanggal 25 Juli 1989. Organisasi mahasiswa dengan nama POLTAPALA (Politeknik Pencinta Alam Lampung) ini dibentuk oleh sekelompok individu yang memiliki kesadaran dan kepedulian terhadap kelestarian lingkungan. Terdiri dari mahasiswa yang memiliki minat dan kasih sayang terhadap alam, lingkungan, serta kegiatan di alam terbuka. POLTAPALA berperan sebagai tempat bagi mahasiswa yang ingin belajar, menjaga, dan melestarikan alam, serta berkontribusi dalam upaya pelestarian lingkungan melalui kegiatan di alam terbuka.', 'Membentuk kepribadian mahasiswa yang kreatif dan bertanggung jawab terhadap lingkungan masyarakat.', 'Mewujudkan sumber daya manusia yang peka terhadap alam dan lingkungan untuk melaksanakan fungsi sosial dan ikut serta mengatasi masalah alam, sosial, dan lingkungan.', '1689398318_0e9cb3413b35c62d19ca.jpg', '1689398318_9e50de729286b98710f3.jpg', '2023-07-15 05:18:38', '2023-07-15 05:22:15');
...
--
ALTER TABLE `tb_kontak`
  ADD CONSTRAINT `tb_kontak_ibfk_1` FOREIGN KEY (`id_ukm`) REFERENCES `tb_ukm` (`id_ukm`);
COMMIT;
